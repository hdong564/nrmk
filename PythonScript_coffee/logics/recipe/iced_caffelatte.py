...
def do_recipe(context: Context, coffee: Coffee):
    ...
    context.get_scheduler().add_event_listener(IceDispArgs, on_ice_listener).add_schedule(Job(None, IceDispArgs(IceDispArgs.EVENT_CODE_REQUEST, coffee)))
    is_waiting_ice = True
