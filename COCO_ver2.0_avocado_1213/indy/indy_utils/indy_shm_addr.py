...
INDY_SHM_ROBOT_ADDR_CTRL_STATUS_EMERGENCY = 0x063001
INDY_SHM_ROBOT_ADDR_CTRL_STATUS_COLLISION = 0x063002
INDY_SHM_ROBOT_ADDR_CTRL_STATUS_ERROR = 0x063003
...
INDY_SHM_CLIENT_ADDR8_CMD_SET_PROGRAM_RATIO = 0x400320
INDY_SHM_CLIENT_ADDR8_CMD_SET_COMMAND_RATIO = 0x400321
...
INDY_SHM_CLIENT_ADDR64_VAL_REDUCED_SPD_RATIO = 0x5004A0    #8byte

INDY_SHM_CLIENT_ADDR64_VAL_PROGRAM_SPD_RATIO = 0x5004A8    #8byte
INDY_SHM_CLIENT_ADDR64_VAL_COMMAND_SPD_RATIO = 0x5004B0    #8byte
...
INDY_SHM_EL1008_DI_2 = 0x7F0008 # 1byte 
